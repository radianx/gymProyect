...
public class ControladorReporte {
    ...
    public void generarReporteAsistencias(List<IngresosPuerta> listaIngresos) {
                ...
                for (Cajadiaria caja : cajas) {
                    ...
                    for (Movimiento unMov : listaMovimientosDeHoy) {
                        ...
                        if (caja.getCierre() == null) {
                            JOptionPane.showMessageDialog(null, "Debe cerrar la caja para generar el reporte.");
                            stop = true;
                            break;
                        }
                        LocalTime cierreCaja = Instant.ofEpochMilli(caja.getCierre().getTime()).atZone(ZoneId.systemDefault()).toLocalTime();
