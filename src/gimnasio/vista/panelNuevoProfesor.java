...
public class panelNuevoProfesor extends javax.swing.JPanel {
    ...
    private void btnActivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActivarActionPerformed
        try {
            ...
            miControlador.agregarProfesor(unProfesor.getUsuario(),unProfesor.getNombreprofesor(),unProfesor.getApellidoprofesor(),unProfesor.getPeso(),unProfesor.getAltura(),unProfesor.getFechanacimiento(),unProfesor.getContacto());
